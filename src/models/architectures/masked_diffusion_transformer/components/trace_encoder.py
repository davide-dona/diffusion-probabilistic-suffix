...
class TraceEncoder(nn.Module):
    ...
    A learned CLS token is prepended to the sequence, and its encoded row summarizes the prefix
    for the suffix-length head. The token is internal to the encoder.
    """
